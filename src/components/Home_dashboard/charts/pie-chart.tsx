...
const desktopData = [
  { month: "january", attendance: 186, fill: "var(--color-january)" },
  { month: "february", attendance: 305, fill: "var(--color-february)" },
  { month: "march", attendance: 237, fill: "var(--color-march)" },
  { month: "april", attendance: 173, fill: "var(--color-april)" },
  { month: "may", attendance: 209, fill: "var(--color-may)" },
];
                  ...
                  if (viewBox && "cx" in viewBox && "cy" in viewBox) {
                    return (
                      ...
                      >
                        ...
                        >
                          {desktopData[activeIndex].attendance.toLocaleString()}
                        </tspan>
                        <tspan
                          x={viewBox.cx}
                          y={(viewBox.cy || 0) + 24}
